              ...
              <div className="container px-4 md:px-6 relative">
                ...
                >
                  ...
                  <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                    ...
                    automate, and deliver exceptional results. Streamline your
              ...
              <div className="container px-4 md:px-6">
                ...
                >
                  ...
                  <p className="max-w-[800px] text-muted-foreground md:text-lg">
                    ...
                    to streamline your workflow, boost productivity, and achieve
                    your goals.
                  </p>
                </motion.div>
            ...
            <section className="w-full py-20 md:py-32 bg-muted/30 relative overflow-hidden">
              ...
              <div className="container px-4 md:px-6 relative">
                ...
                >
                  ...
                  <p className="max-w-[800px] text-muted-foreground md:text-lg">
                    Get started in minutes and see the difference our platform
            ...
            <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
              ...
              <div className="flex flex-col gap-4 sm:flex-row justify-between items-center border-t border-border/40 pt-8">
                <p className="text-xs text-muted-foreground">
                  &copy; {new Date().getFullYear()} SaaSify. All rights
                  reserved.
                </p>
                <div className="flex gap-4">
                  <Link
